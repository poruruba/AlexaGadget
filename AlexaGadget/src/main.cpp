...
const char *AlexaGadgetSecret = "【Alexaガジェットのシークレット】";
const char *EndpointId = "【ガジェットの識別子】";
const char *FriendlyName ="【製品ID】";
const char *DeviceToken = "【デバイストークン】";
const char *FirmwareVersion = "【ファームウェアバージョン】";
